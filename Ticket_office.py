...
"""
Ticket office
Este programa tiene como salida el porcentaje de crecimiento de los ingresos
de una taquilla, si el descuento se dio a las personas menores de esa edad
@author: JCGS
"""
...
age = int(input('Ingrese la edad de descuento :'))
...
for var in data.values():
    if var < age:
        ...
        new += 20
if age < 18:
    print(int((new - old) / old * 100),'{}'.format('%'))
else:
    print(0)